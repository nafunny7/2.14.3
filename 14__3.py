...
async def get_buying_list(message):
    ...
    with open("2.png", "rb") as img:
        await message.answer_photo(img, f"Название: Product1 | Описание: описание 1 | Цена: 200")
    with open("3.png", "rb") as img:
        await message.answer_photo(img, f"Название: Product1 | Описание: описание 1 | Цена: 300")
    with open("4.png", "rb") as img:
        await message.answer_photo(img, f"Название: Product1 | Описание: описание 1 | Цена: 400")
